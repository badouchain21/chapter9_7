...
;(function ($, window, document, undefined) {
  ...
  var Shutter = function (elem, options) {
    this.defaults = {
      ...
      moveType: null,// 13种切换方式 需要自己体会
      showPrevNext:true,//是否显示左右切换按钮
      showDesc:false//是否显示下方描述
    };
  ...
  Shutter.prototype = {
    ...
    if(this.opts.showDesc)
      ...
      var movetype =  this.opts.moveType != null ? this.opts.moveType : random(0, 13);
 
      	this.moveSwitch(movetype, command, index);
    ...
    inital: function (elem) {
	 ...
	 this.$shutter.find('.shutter-btn').show();
      ...
      if(this.opts.showDesc)
	 this.$shutter.find('.shutter-desc').show();	
