    ...
    export default {
        ...
        methods: { // 定义函数
            querySearch (queryString, cb) {
                let demoAutoCompleteList = this.demoAutoCompleteList
                let results = queryString ? demoAutoCompleteList.filter(this.createFilter(queryString)) : demoAutoCompleteList
        ...
        // 挂载完成，可访问DOM元素
        mounted () {
            this.demoAutoCompleteList = this.loadAll()
        }
    }
</script>
