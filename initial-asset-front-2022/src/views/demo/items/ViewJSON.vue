            ...
            formHelloList: [
                {
                    title: '标题1',
                    list: [
                        { type: 'text', label: '普通标签', name: 'common', value: '1222', iconName: 'point-fill' },
                        { type: 'text', label: '占比变宽标签', name: 'largePer', value: '占比变宽标签', columnPer: 16, iconName: 'people-fill' },
                        ...
                        { type: 'textarea', label: '文本域', name: 'textarea', value: '说到文本域，那这里肯定是有很多' },
