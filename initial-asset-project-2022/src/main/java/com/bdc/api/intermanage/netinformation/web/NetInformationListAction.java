...
@Controller
@RequestMapping("/api/intermanager/netinformation/netinformationlist")
public class NetInformationListAction extends BaseCommonListAction {

	/**
	 * @Field @serialVersionUID : TODO(使用模型配置配置视图继承BaseCommonListAction)
	 */


    @RequestMapping
    @BaseMdJsonStack
	public void netinformationList() throws Exception {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/template/netinformation/netinformationlist_list.jsp").forward(request,response);
	}
