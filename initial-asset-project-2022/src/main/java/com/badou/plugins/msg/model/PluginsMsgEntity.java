...
@Table(name = "sys_plugins_msg")
@Cache(usage = CacheConcurrencyStrategy.NONE) //缓存配置
public class PluginsMsgEntity extends  com.badou.designer.module.design.base.BaseModuleEntity implements  IUniqueCodeEntity { 
     ...
     * 插件对应文件
     */
	@JoinColumn(name = "plugins_file_id", referencedColumnName = "ID", insertable = false, updatable = false)
	@ManyToOne
    protected PluginsFileEntity pluginsFileEntity;
	/**
     * 插件唯一编码
     */
  ...
  /*  *//**
	...
	*//**
	...
	/**
	 * @return pluginsFileEntity
	 */
	public PluginsFileEntity getPluginsFileEntity() {
		return pluginsFileEntity;
	}

	public void setPluginsFileEntity(PluginsFileEntity pluginsFileEntity) {
		this.pluginsFileEntity = pluginsFileEntity;
	}
